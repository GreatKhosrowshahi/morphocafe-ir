            ...
            <div className="flex-1 flex items-center justify-center pt-20 px-4 pb-20">
                ...
                >
                    <div className="flex flex-col items-center mb-10 text-center">
                        ...
                        <h1 className="text-3xl font-extrabold text-white tracking-tight">ورود مشتریان</h1>
                        <p className="text-white/40 text-[10px] font-bold uppercase tracking-[0.2em] mt-3">Access your Morpho Account</p>
                    </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5 text-center">
                        <p className="text-white/40 text-sm">
                            ...
                            <Link to="/register" className="text-accent font-bold hover:underline">ایجاد حساب جدید</Link>
                        </p>
                    </div>
                </motion.div>
            </div>
